    ...
    return(
        <section id="hero-section" className="h-260 flex flex-col justify-around px-4">
            ...
            <div id="explore-experience" className="flex flex-col items-center">
                <p id="explore-experience-text" className="flex flex-col items-center text-lg text-secondary-color border-2 border-blue-600 rounded-4xl p-4">Explore My Experience</p> 
