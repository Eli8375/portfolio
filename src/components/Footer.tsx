    ...
    return(
        <footer id="footer" className="h-100 bg-blue-600 text-white py-6 flex justify-center">
            <div id="footer-content" className="px-4 flex flex-col justify-between text-sm items-center m-5">
                ...
                <a id='download-resume' href="resume.pdf" download="resume.pdf" className='border-2 p-2 rounded-2xl hover:text-blue-600 hover:bg-white hover:border-white'>DOWNLOAD RESUME</a>
            </div>
        </footer>
    )
}